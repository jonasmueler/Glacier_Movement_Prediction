...
# import data
df = pd.read_csv('/media/jonas/B41ED7D91ED792AA/Arbeit_und_Studium/Kognitionswissenschaft/Semester_5/masterarbeit#/data_Code/code/experiment3/LSTMAttentionSmallMixedDataLosses.csv')
