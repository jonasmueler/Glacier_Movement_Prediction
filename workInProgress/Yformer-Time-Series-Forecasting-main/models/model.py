...
from attn import *
from embed import *
#from .encoder import Encoder, EncoderLayer, ConvLayer, EncoderStack,  YformerEncoder
#from .decoder import Decoder, DecoderLayer, YformerDecoderLayer, YformerDecoder, DeConvLayer, YformerDecoder_skipless, YformerDecoderLayer_skipless
...
model = Yformer(7, 7, 4, 4, 2500, 4,
                factor=5, d_model=512, n_heads=1, e_layers=1, d_layers=1, d_ff=512,
                dropout=0.0, attn='prob', embed='fixed', freq='h', activation='gelu',
                output_attention = False, distil=True,
                device=torch.device('cpu'))

test = torch.rand(4,50,50)
print(model(test))