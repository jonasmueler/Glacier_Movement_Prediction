...
model = functions.loadCheckpoint(model, None, os.path.join(pathOrigin, "models", "LSTMAttentionSmallMixedData"))
print("loading models finished")

# dataLoader /home/jonas/datasets/parbati
datasetTest = datasetClasses.glaciersTest(os.path.join(pathOrigin, "datasets", "parvatiTest"), "test")
...
with torch.no_grad():
    ...
    modelName = "LSTMAttentionSmallMixedData"
